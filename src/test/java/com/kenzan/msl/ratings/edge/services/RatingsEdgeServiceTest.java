...
public class RatingsEdgeServiceTest {
    ...
    public void testRateContent() {
        EasyMock.expect(cassandraRatingsService.addOrUpdateUserRatings(EasyMock.anyObject())).andReturn(Observable
                                                                                                            .empty());
        EasyMock.expect(cassandraRatingsService.addOrUpdateAverageRating(EasyMock.anyObject())).andReturn(Observable
                                                                                                              .empty());
        ...
        ratingsEdgeService.rateContent(tc.ALBUM_ID.toString(), tc.RATING, tc.USER_ID.toString(), tc.ALBUM_CONTENT_TYPE);
    }
    ...
    public void testInvalidContentType() {
        ...
        RatingsEdgeService ratingsEdgeService = new RatingsEdgeService();
        ratingsEdgeService
            .rateContent(tc.ALBUM_ID.toString(), tc.RATING, tc.USER_ID.toString(), "INVALID_CONTENT_TYPE");
    }
}
