...
public class RatingsEdgeSessionTokenImpl implements RatingsEdgeSessionToken {
    ...
    /**
     * Returns the sessionToken in a cookie format, if a sessionToken is passed it updates the RatingsEdgeSessionTokenImpl value with it
     *
     * @param sessionToken value to update RatingsEdgeSessionTokenImpl.value with
     * @return NewCookie
     */
